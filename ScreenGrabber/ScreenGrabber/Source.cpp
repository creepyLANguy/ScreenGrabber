...
6. If you do step 4, you'll need to wait a certain amount of time to give the servers a chance to reconfigure themselves.
7. Run the corresponding function for the configured capture mode. May loop indefinitely.
8. Clean up anything that needs cleaning up. May not be reached in some modes.
*/
